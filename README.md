...
4. 
## مايميز هاذى المشرؤع عن سابقة
    أنة جاهز لكي تقوم بااخراجة على شكل ملف EXE  ويفضل استخدام الاداة المدمجة في Visual Studio الي اسمها "Microsoft visual studio installer projects 2022"

 ## المشرؤع راح يتطور في المستقبل ليضيف اشياء اكثر مع التركيز على SQLite
